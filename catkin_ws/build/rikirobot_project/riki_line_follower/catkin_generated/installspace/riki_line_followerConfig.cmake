...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'riki_line_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/riki/catkin_ws/install/${idir}'.  Ask the maintainer 'sudartion <sudartion@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/riki/catkin_ws/install/lib;/home/riki/google_ws/devel_isolated/cartographer_rviz/lib;/home/riki/google_ws/install_isolated/lib;/home/riki/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
