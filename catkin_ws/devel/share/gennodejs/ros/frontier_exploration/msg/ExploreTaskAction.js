...
class ExploreTaskAction {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = ExploreTaskActionGoal.serialize(obj.action_goal, bufferInfo);
    // Serialize message field [action_result]
    bufferInfo = ExploreTaskActionResult.serialize(obj.action_result, bufferInfo);
    // Serialize message field [action_feedback]
    bufferInfo = ExploreTaskActionFeedback.serialize(obj.action_feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new ExploreTaskAction();
    // Deserialize message field [action_goal]
    tmp = ExploreTaskActionGoal.deserialize(buffer);
    data.action_goal = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_result]
    tmp = ExploreTaskActionResult.deserialize(buffer);
    data.action_result = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_feedback]
    tmp = ExploreTaskActionFeedback.deserialize(buffer);
