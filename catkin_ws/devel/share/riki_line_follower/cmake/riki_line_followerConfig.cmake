...
if("TRUE" STREQUAL "TRUE")
  set(riki_line_follower_SOURCE_PREFIX /home/riki/catkin_ws/src/rikirobot_project/riki_line_follower)
  set(riki_line_follower_DEVEL_PREFIX /home/riki/catkin_ws/devel)
  ...
  set(riki_line_follower_INSTALL_PREFIX /home/riki/catkin_ws/install)
...
if(NOT "/home/riki/catkin_ws/devel/include " STREQUAL " ")
  set(riki_line_follower_INCLUDE_DIRS "")
  set(_include_dirs "/home/riki/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'riki_line_follower' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'sudartion <sudartion@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'riki_line_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/riki/catkin_ws/src/rikirobot_project/riki_line_follower/${idir}'.  Ask the maintainer 'sudartion <sudartion@todo.todo>' to fix it.")
    endif()
