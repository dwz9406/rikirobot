...
if("TRUE" STREQUAL "TRUE")
  set(imu_calib_SOURCE_PREFIX /home/riki/catkin_ws/src/rikirobot_project/imu_calib)
  set(imu_calib_DEVEL_PREFIX /home/riki/catkin_ws/devel)
  ...
  set(imu_calib_INSTALL_PREFIX /home/riki/catkin_ws/install)
...
if(NOT "/home/riki/catkin_ws/src/rikirobot_project/imu_calib/include;/usr/include/eigen3 " STREQUAL " ")
  set(imu_calib_INCLUDE_DIRS "")
  set(_include_dirs "/home/riki/catkin_ws/src/rikirobot_project/imu_calib/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'imu_calib' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Daniel Koch <daniel.p.koch@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'imu_calib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/riki/catkin_ws/src/rikirobot_project/imu_calib/${idir}'.  Ask the maintainer 'Daniel Koch <daniel.p.koch@gmail.com>' to fix it.")
    endif()
