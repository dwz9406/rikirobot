  ...
  public:
    ...
    public:
      ParamDescription(std::string name, std::string type, uint32_t level, 
          std::string description, std::string edit_method, T PyramidsConfig::* f) :
...
//#line 280 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(PyramidsConfig::AbstractParamDescriptionConstPtr(new PyramidsConfig::ParamDescription<int>("pyramids_type", "int", 0, "Pyramids Type", "{'enum_description': 'An enum for Pyramids Types', 'enum': [{'srcline': 10, 'description': 'Zoom In', 'srcfile': '/home/riki/catkin_ws/src/opencv_apps/cfg/Pyramids.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Up'}, {'srcline': 11, 'description': 'Zoom Out', 'srcfile': '/home/riki/catkin_ws/src/opencv_apps/cfg/Pyramids.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Down'}]}", &PyramidsConfig::pyramids_type)));
//#line 280 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 10 "/home/riki/catkin_ws/src/opencv_apps/cfg/Pyramids.cfg"
      const int Pyramids_Up = 0;
//#line 11 "/home/riki/catkin_ws/src/opencv_apps/cfg/Pyramids.cfg"
